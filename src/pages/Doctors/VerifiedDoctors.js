...
function VerifiedDoctors() {
    ...
    // Getting Verified Doctor List
    useEffect(() => {
        axios.get(globalVar.backendURL + "/admin/verified-doctors").then((res) => {
            ...
            setHTMLDoctorList(
                data.map(doctor =>
                    ...
                    >
                        ...
                        <div className='verificationBadge verified'>
                            Verified
                        </div>
                    </div>
                )
        ...
        <div id="SuperDoctorsPage">
            ...
            <div id='AdminDoctorsFeed'>
                {htmlDoctorList.length > 0 ? htmlDoctorList :
                    !loadingStatus && <div className='NoDoctorsToDisplay'>No Verified Doctors</div>
                }
            </div>
        </div>
    );
